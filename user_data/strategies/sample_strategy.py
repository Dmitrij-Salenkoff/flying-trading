...
class SampleStrategy(IStrategy):
    ...
    buy_rsi = IntParameter(low=1, high=50, default=30, space="enter", optimize=True, load=True)
    sell_rsi = IntParameter(low=50, high=100, default=70, space="exit", optimize=True, load=True)
    short_rsi = IntParameter(low=51, high=100, default=70, space="enter", optimize=True, load=True)
